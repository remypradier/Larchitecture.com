...
<p><a href="Revues/addRevues.php">Ajouter</a></p>
<table>
    <tr>
        <td>ID</td>
        <td>Nom</td>
    ...
    <?php foreach ($afficheAll as $affichage) : ?>
        <tr>
            ...
            <td><a href="Revues/detailsRevues.old.php?id=<?= $affichage['id'] ?>">Modifier</a></td>
            <td><a href="Revues/deleteRevues.php?id=<?= $affichage['id'] ?>">Supprimer</a></td>
        </tr>
    <?php endforeach; ?>
